dataImportTab <- tabItem(tabName = "dataImport",
                ...
                fluidRow(
                    column(4,
                          ...
                          selectInput("dat_type","Input Type",choices=list("Processed Expression Data (CSV/TXT File)","Raw Affymetrix Data (CEL Files)","GEO Accession Number"),
                                width = '350px'
                                 )),
                    column(3,
                    ...
                    column(3,      
                          ...
                          selectInput("oligo","What microarray platform did you use?",choices=list("Affymetrix Human Gene 1.0 ST Array","Affymetrix Human Genome U133 Plus 2.0 Array"))
                          ),
