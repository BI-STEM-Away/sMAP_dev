  ...
  sidebarMenu(id = "tabs",
              ...
              menuItem("Quality Control", tabName = "qualityControl", 
                       ...
                       menuSubItem("Batch Correction", tabName = "batchCorrection",
                                   icon = icon("object-group")),
                       menuSubItem("Find Potential Outliers", tabName = "potentialOutliers",
                                   icon = icon("object-group"))
              ),
              ...
              menuItem("Functional", tabName = "functionalAnalysis", 
                       icon = icon("chart-bar"),
                       menuSubItem("Functional Enrichment Analysis", tabName="functionalEnrichmentAnalysis",
                                   icon = icon("chart-bar")),
                       menuSubItem("Gene-Concept Network", tabName="geneConceptNetwork",
                                   icon = icon("chart-bar")),
                       menuSubItem("GSEA", tabName="gsea",
                                   icon = icon("chart-bar")),
                       menuSubItem("Transcription Factor Analysis", tabName="transcriptionFactorAnalysis",
                                   icon = icon("chart-bar"))
              ),
